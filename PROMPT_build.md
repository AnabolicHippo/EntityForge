...
2. After implementing functionality or resolving problems, run the tests for that unit of code that was improved. If functionality is missing then it's your job to add it as per the application specifications. Think carefully.
...
99999999999999. If you find inconsistencies in the specs/* then update them.
